...
* [Samples for Ktor](https://github.com/ktorio/ktor-samples) ⭐ 1,618 | 🐛 14 | 🌐 Kotlin | 📅 2026-08-07 A collection of ready-to-use samples for Ktor.
...
* [Ktor Arrow Real World Example](https://github.com/nomisRev/ktor-arrow-example) ⭐ 305 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-12 Real World implementation - "The mother of all demo apps". Written in Kotlin, with Ktor, Arrow, SqlDelight, KotlinX Serialization, etc.
...
* [Cohort](https://github.com/sksamuel/cohort) ⭐ 184 | 🐛 24 | 🌐 Kotlin | 📅 2026-08-06 Spring Actuator style replacement for Ktor. Provides health checks for orchestrators like Kubernetes and management of logging, databases, JVM settings, memory and threads in production.
